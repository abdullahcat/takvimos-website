...
function IsAlanlari() {
    return (
        <section className="bg-white pt-20 px-4 min-h-screen">
            <Head>
                <title>Hizmet Alanları</title>
            </Head>
            <h1 className='text-3xl   tracking-tight text-black  py-5 sm:leading-none text-start'>Hizmet Verdiğimiz İşletmeler</h1>

            <div className="grid py-5 grid-cols-1 text-black gap-4 lg:grid-cols-3 lg:gap-8">
                <div className="group bg-orange-300 relative block h-64 sm:h-80 lg:h-96">
                    <span className="absolute inset-0 border-2 border-dashed border-black"></span>

                    <div
                        className=" cursor-pointer relative flex h-full transform items-end border-2 border-black bg-white transition-transform group-hover:-translate-x-2 group-hover:-translate-y-2"
                    >
                        <div
                            className="p-4 !pt-0 transition-opacity group-hover:absolute group-hover:opacity-0 sm:p-6 lg:p-8"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="6" cy="6" r="3"></circle><circle cx="6" cy="18" r="3"></circle><line x1="20" y1="4" x2="8.12" y2="15.88"></line><line x1="14.47" y1="14.48" x2="20" y2="20"></line><line x1="8.12" y1="8.12" x2="12" y2="12"></line></svg>


                            <h2 className="mt-4 text-xl font-medium sm:text-2xl">Berberler ve Kuaförler</h2>
                        </div>

                        <div
                            className="absolute p-4 opacity-0 transition-opacity group-hover:relative group-hover:opacity-100 sm:p-6 lg:p-8"
                        >
                            <h3 className="mt-4 text-xl font-medium sm:text-2xl">Berberler ve Kuaförler</h3>
                ...
                <div className="group bg-red-300 relative block h-64 sm:h-80 lg:h-96">
                    <span className="absolute inset-0 border-2 border-dashed border-black"></span>
                    ...
                    >
                        <div
                            className="p-4 !pt-0 transition-opacity group-hover:absolute group-hover:opacity-0 sm:p-6 lg:p-8"
                        >
                            <svg fill="#000000" width="28" height="28" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M9,1A1,1,0,0,0,8,2v9H7a1,1,0,0,0-1,1V22a1,1,0,0,0,1,1H17a1,1,0,0,0,1-1V12a1,1,0,0,0-1-1H16V8A7.008,7.008,0,0,0,9,1Zm1,2.1A5.008,5.008,0,0,1,14,8v3H10ZM9,13h7v2H8V13ZM8,21V17h8v4Z" /></svg>


                            <h2 className="mt-4 text-xl font-medium sm:text-2xl">Güzellik Salonları</h2>
                        </div>

                        <div
                            className="absolute p-4 opacity-0 transition-opacity group-hover:relative group-hover:opacity-100 sm:p-6 lg:p-8"
                        >
                            <h3 className="mt-4 text-xl font-medium sm:text-2xl">Güzellik Salonları</h3>
                ...
                <div className="group bg-purple-300 relative block h-64 sm:h-80 lg:h-96">
                    <span className="absolute inset-0 border-2 border-dashed border-black"></span>
                    ...
                    >
                        <div
                            className="p-4 !pt-0 transition-opacity group-hover:absolute group-hover:opacity-0 sm:p-6 lg:p-8"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><g transform="translate(2 3)"><path d="M20 16a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V5c0-1.1.9-2 2-2h3l2-3h6l2 3h3a2 2 0 0 1 2 2v11z" /><circle cx="10" cy="10" r="4" /></g></svg>


                            <h2 className="mt-4 text-xl font-medium sm:text-2xl">Fotoğrafçılar</h2>
                        </div>

                        <div
                            className="absolute p-4 opacity-0 transition-opacity group-hover:relative group-hover:opacity-100 sm:p-6 lg:p-8"
                        >
                            <h3 className="mt-4 text-xl font-medium sm:text-2xl">Fotoğrafçılar</h3>
                ...
                <div className="group bg-blue-300 relative block h-64 sm:h-80 lg:h-96">
                    <span className="absolute inset-0 border-2 border-dashed border-black"></span>
                    ...
                    >
                        <div
                            className="p-4 !pt-0 transition-opacity group-hover:absolute group-hover:opacity-0 sm:p-6 lg:p-8"
                        >
                            <svg width="28" height="28" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" x="http://www.w3.org/1999/xlink"
                                viewBox="0 0 512 512"   >
                                <style type="text/css">
		...
		c4.751,4.527,8.24,9.11,10.499,13.588c2.267,4.492,3.341,8.835,3.355,13.271V305.658z"/>
                            ...
                            <h2 className="mt-4 text-xl font-medium sm:text-2xl">Düğün Salonları</h2>
                        </div>

                        <div
                            className="absolute p-4 opacity-0 transition-opacity group-hover:relative group-hover:opacity-100 sm:p-6 lg:p-8"
                        >
                            <h3 className="mt-4 text-xl font-medium sm:text-2xl">Düğün Salonları</h3>

                            <p className="mt-4 text-sm sm:text-base">
                                Düğün salonları için düzenli rezervasyonlar ve etkinlik planlama.</p>                          </div>
                    </div>
                </div>
                <div className="group bg-green-300 relative block h-64 sm:h-80 lg:h-96">
                    <span className="absolute inset-0 border-2 border-dashed border-black"></span>
                    ...
                    >
                        ...
                        >
                            ...
                            <h2 className="mt-4 text-xl font-medium sm:text-2xl">Öğretmenler</h2>
                        </div>

                        <div
                            className="absolute p-4 opacity-0 transition-opacity group-hover:relative group-hover:opacity-100 sm:p-6 lg:p-8"
                        >
                            <h3 className="mt-4 text-xl font-medium sm:text-2xl">Öğretmenler</h3>
                ...
                <div className="group relative bg-indigo-300 block h-64 sm:h-80 lg:h-96">
                    <span className="absolute inset-0 border-2 border-dashed border-black"></span>
                    ...
                    >
                        ...
                        >
                            ...
                            <h2 className="mt-4 text-xl font-medium sm:text-2xl">Spor Tesisleri</h2>
                        </div>

                        <div
                            className="absolute p-4 opacity-0 transition-opacity group-hover:relative group-hover:opacity-100 sm:p-6 lg:p-8"
                        >
                            <h3 className="mt-4 text-xl font-medium sm:text-2xl">Spor Tesisleri</h3>
                ...
                <div className="group relative bg-pink-300 block h-64 sm:h-80 lg:h-96">
                    <span className="absolute inset-0 border-2 border-dashed border-black"></span>
                    ...
                    >
                        ...
                        >
                            ...
                            <h2 className="mt-4 text-xl font-medium sm:text-2xl">Klinikler</h2>
                        </div>

                        <div
                            className="absolute p-4 opacity-0 transition-opacity group-hover:relative group-hover:opacity-100 sm:p-6 lg:p-8"
                        >
                            <h3 className="mt-4 text-xl font-medium sm:text-2xl">Klinikler</h3>
                ...
                <div className="group relative block bg-yellow-300 h-64 sm:h-80 lg:h-96">
                    <span className="absolute inset-0 border-2 border-dashed border-black"></span>
                    ...
                    >
                        ...
                        >
                            ...
                            <h2 className="mt-4 text-xl font-medium sm:text-2xl">Danışmanlar</h2>
                        </div>

                        <div
                            className="absolute p-4 opacity-0 transition-opacity group-hover:relative group-hover:opacity-100 sm:p-6 lg:p-8"
                        >
                            <h3 className="mt-4 text-xl font-medium sm:text-2xl">Danışmanlar</h3>
