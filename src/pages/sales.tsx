        ...
        <section className="bg-white pt-20   min-h-screen">
            ...
            <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
                <div className="grid grid-cols-1  text-blue-500 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
                    ...
                    >
                        ...
                        <ul className="mt-6 space-y-2">
                            ...
                            <li className="flex items-center gap-1">
                                ...
                                <span className="">Müşteri Rezarvasyonu</span>
                            </li>
                            ...
                            <li className="flex items-center gap-1">
                                ...
                                <span className="">Email ve SMS Hatırlatıcı</span>
                            </li>
                    ...
                    <div
                        className="justify-center items-center flex flex-col space-y-4 rounded-xl border  border-gryıl-200 p-6 shadow-sm sm:px-8 lg:p-12"
                    >
                        <div className="text-center">
                            <h2 className="text-lg font-medium ">
                                Başlangıç Paketi
